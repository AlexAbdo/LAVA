...
class ViewController: UIViewController, CLLocationManagerDelegate {
    ...
    //var mobup = PFObject()
    var mobupobj = PFObject(className:"MobUp")
    var added = 0
...
//        }
    ...
    func addLocationToTable() {
        ...
        if added == 0 {
            mobupobj["numTimesUpdated"] = 0
            added += 1
        }
        

        do {
            mobupobj.incrementKey("numTimesUpdated")
            try mobupobj.save()
            print("MobUp object saved")
        } catch {
            print("Could not save MobUp object")
        }
...
//            let mobupobj = PFObject(className:"MobUp")
//            
//            mobupobj["numTimesUpdated"] = 1
//            mobupobj.objectId = curruser!.objectId!
//            
//            do {
//                try mobupobj.save()
//                print("MobUp object saved")
